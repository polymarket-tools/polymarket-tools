#!/usr/bin/env python3
"""Import CapitolBets signal workflows into production n8n instance."""
import json
import os
import urllib.request

N8N_URL = "http://localhost:5679"
WORKFLOWS_DIR = os.path.join(os.path.dirname(__file__), "..", "packages", "capitolbets", "n8n-workflows")
